...
class __TwigTemplate_494a29d973e674ac36def0d52777baecdfcf652c1345d4362032dec8fd6d804d extends \Twig\Template
{
    private $source;
    private $macros = [];
 ...
 'de vouloir supprimer cette catégorie ?');\">
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('category_delete', {'id': category.id}) }}\" onsubmit=\"return confirm('Êtes-vous sûr.e ' +
 'de vouloir supprimer cette catégorie ?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
