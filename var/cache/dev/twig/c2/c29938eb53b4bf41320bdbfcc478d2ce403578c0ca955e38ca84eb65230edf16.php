...
/* tag/show.html.twig */
class __TwigTemplate_526e98e240daad5a4e4145011e37cc7b6f607b92c27d98e92bb832671764cd8c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container mb-3 pb-4\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["tag"]) || array_key_exists("tag", $context) ? $context["tag"] : (function () { throw new RuntimeError('Variable "tag" does not exist.', 11, $this->source); })()), "articles", [], "any", false, false, false, 11));
...
";
    ...
    {
        return array (  141 => 27,  136 => 25,  131 => 23,  126 => 20,  115 => 14,  103 => 12,  98 => 11,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"container\">
        <h1 class = \"text-center pt-3 pb-3\">{{ tag.name }}</h1>
    </div>
    <div class=\"container mb-3 pb-4\">
        <h2>Articles correspondants:</h2>
...
{% endblock %}", "tag/show.html.twig", "/Users/malika/Desktop/Blog 2/templates/tag/show.html.twig");
    }
}
