...
$b = ($this->privates['App\\Service\\Slugify'] ?? ($this->privates['App\\Service\\Slugify'] = new \App\Service\Slugify()));

$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ArticleFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []]]);
