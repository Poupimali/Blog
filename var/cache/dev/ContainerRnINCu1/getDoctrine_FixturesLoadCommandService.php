...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ArticleFixtures(($this->privates['App\\Service\\Slugify'] ?? ($this->privates['App\\Service\\Slugify'] = new \App\Service\Slugify()))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []]]);
