...
// Returns the private 'App\Repository\SlugRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SlugRepository.php';

return $this->privates['App\\Repository\\SlugRepository'] = new \App\Repository\SlugRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
